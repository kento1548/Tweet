        ...
        <ClickAwayListener onClickAway={handleClickAwayTopTweetActions}>
            <div>
                <div className={classes.headerIcon}>
                    <ActionIconButton actionText={"Top Tweets"} icon={TopTweets} onClick={handleClickTopTweetActions}/>
                </div>
                {openTopTweetActions && (
                                ...
                                <div className={classes.listItemWrapper}>
                                    ...
                                    <div>
                                        <Typography variant={'subtitle2'} component={'div'}>
                                            {switchTweets ? "You'll see top Tweets first." : "You'll see Tweets up as they happen"}
                                        </Typography>
                                    </div>
                                </div>
                            </ListItem>
