...
const TweetInteractionCoun = memo(():ReactElement => {
    ...
    const [usersListModalAction,setUsersListModalWindowAction] = useState<UsersListModalAction>(UsersListModalAction.LIKED);

    const onOpenLikesModalWindow = (): void => {
        setVisibleUsersListModalWindow(true);
        setUsersListModalWindowAction(UsersListModalAction.LIKED);
    };

    const onOpenRetweetsModalWindow = (): void => {
        setVisibleUsersListModalWindow(true);
        setUsersListModalWindowAction(UsersListModalAction.RETWEETED);
    };
...
export default TweetInteractionCoun;